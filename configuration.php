...
class JConfig
{
	...
	public $user = 'aurymmezsfhbog';                       // DB username
	public $password = '5d11653d2cffafad310e69c2a9e6a73688fdba3fa9e3e583ccdce4dc420735cf';                   // DB password
	public $db = 'd73gv86snvdq7p';                         // DB database name
	public $dbprefix = 'f8jwc_';               // Do not change unless you need to!
